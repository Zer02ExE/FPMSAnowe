...
<div class="sidebar" onmouseover="openNav()" onmouseout="closeNav()">
  ...
  <div id="datetime">
    ...
    <div id="contentm">  
          ...
          <table>
            ...
            <?php
              if (isset($_POST['data'])) {
                ...
                setcookie("miesiac",$data,time()+(86400*30),"/");
        ...
        <?php
          echo "<table><tr><td>DANE</td><td>KWOTA</td></tr>";
          echo '<tr><td>Zużycie wody - rozliczenie(m3)</td><td>'.$suma_miesiac.'</td></tr>';
          echo '<tr><td>Cena wody - rozliczenie(kwota)</td><td>'.$suma_kwota.'</td></tr>';
          echo '<tr><td>Suma</td><td>' . $suma_pozostala . '</td></tr>';
          echo '<tr><td>Zużycie wody podkladka + działki  </td><td>'.$sumzuz.'</td></tr>';
          echo '<tr><td>Cena wody podkladka + działki  </td><td>'.$sumall.'</td></tr>';
          echo '<tr><td>Zuzycie + cena Rozliczenie </td><td>'.$summk.'</td></tr>';
          echo "<table>";
        ?>
        </div>
